...
#define SET_PA4_IO_IN TRISA |= 0x10
#define SET_PA5_IO_IN TRISA |= 0x20
...
#define SET_PA4_IO_OUT TRISA &= ~0x10
#define SET_PA5_IO_OUT TRISA &= ~0x20


#define SET_PA0_L PA0 = 0
#define SET_PA1_L PA1 = 0
#define SET_PA2_L PA2 = 0
#define SET_PA3_L PA3 = 0
#define SET_PA4_L PA4 = 0
#define SET_PA5_L PA5 = 0


#define SET_PA0_H PA0 = 1
#define SET_PA1_H PA1 = 1
#define SET_PA2_H PA2 = 1
#define SET_PA3_H PA3 = 1
#define SET_PA4_H PA4 = 1
#define SET_PA5_H PA5 = 1

#define SET_PA0_PU_ON PU_PA |= 0x01
#define SET_PA1_PU_ON PU_PA |= 0x02
#define SET_PA2_PU_ON PU_PA |= 0x04
#define SET_PA3_PU_ON PU_PA |= 0x08
#define SET_PA4_PU_ON PU_PA |= 0x10
#define SET_PA5_PU_ON PU_PA |= 0x20

#define SET_PA0_PU_OFF PU_PA &= ~0x01
#define SET_PA1_PU_OFF PU_PA &= ~0x02
#define SET_PA2_PU_OFF PU_PA &= ~0x04
#define SET_PA3_PU_OFF PU_PA &= ~0x08
#define SET_PA4_PU_OFF PU_PA &= ~0x10
#define SET_PA5_PU_OFF PU_PA &= ~0x20
...
#define GET_PA4 (DATAA&0x10)
#define GET_PA5 (DATAA&0x20)
...
#define TRUN_PD0 PD0 = ~PD0
#define TRUN_PD1 PD1 = ~PD1
#define TRUN_PD2 PD2 = ~PD2
#define TRUN_PD3 PD3 = ~PD3
#define TRUN_PD4 PD4 = ~PD4
#define TRUN_PD5 PD5 = ~PD5
#define TRUN_PD6 PD6 = ~PD6
#define TRUN_PD7 PD7 = ~PD7
