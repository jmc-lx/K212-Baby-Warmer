//**********************************************************************************   
//********************   copyright(c) 2021, BME company   **************************   
//************************    All rights reserved    *******************************   
//*****************************  ---  BME  ---  ************************************   
//**********************************************************************************                                              
//========================================================================= 
//  Project Name : MCU07A                                                                                                                     
//  File    Name : BF7613BMXX_XXXX.h 
//  Date         : 2021.02.03                                                              
//  By           : xs                                                                 
//  Version      : V1.0                                 
//=========================================================================  

#ifndef __BF7613BMXX_XXXX_H__
#define __BF7613BMXX_XXXX_H__
/*  ----------------BYTE Register------------------  */
sfr	DATAB					= 0x80;
sfr	SP						= 0x81;
sfr	DPL						= 0x82;
...
sfr	REG_DATA			= 0x97;
sfr	DATAD					= 0x98;
sfr	PWM1_CH0_CNT_L	= 0x99;
sfr	PWM1_CH0_CNT_H	= 0x9A;
sfr	PWM1_CH1_CNT_L	= 0x9B;
sfr	PWM1_CH1_CNT_H	= 0x9C;
sfr	PWM2_CH0_CNT_L	= 0x9D;
sfr	PWM2_CH0_CNT_H	= 0x9E;
sfr	PWM2_CH1_CNT_L	= 0x9F;
sfr	P2_XH					  = 0xA0;
sfr	PWM2_CH1_CNT_H	= 0xA1;
sfr	PWM_EN				= 0xA2;
